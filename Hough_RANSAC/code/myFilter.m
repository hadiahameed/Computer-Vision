...
%          DESCRIPTION:
%          ----------------------------------------------------
%          myFilter() gives a 'gaussian' or 'sobel' filter as an
%          output as mentioned by the input argument 'filter_name'
%          Default size is 3x3 and default sigma for gaussian filter
%          is 1.
%           
